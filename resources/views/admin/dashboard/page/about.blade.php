                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body form-horizontal" >
                        ...
                        @endif
                            ...
                            <h5 class="header-title pb-5">About</h5>       
                                                ...
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('aboutKeyUpdate',$about->id) }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 control-label" for="key_name">Key</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="key_name" value="{{ $about->key_name }}" class="form-control" placeholder="Key">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="value" value="{{ $about->value }}" class="form-control" placeholder="value">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="id" value="{{ $about->id }}" hidden class="form-control" placeholder="value">
                                                                </div>
                                                            </div>
