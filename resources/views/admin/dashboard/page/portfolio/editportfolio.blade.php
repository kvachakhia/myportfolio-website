    ...
    <div class="body-content">
        ...
        <div class="container-fluid">
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="addnewheader">
                            <a href="{{ url('/dashboard/page/portfolio') }}" style="margin: 5px;">
            ...
            <div class="col-xl-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <form action="{{ route('updatePortfolio',$portfolios->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="general-label">
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label" for="title">Title</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="title" value="{{ $portfolios->title }}" class="form-control">
                                        <input type="text" name="id" hidden value="{{ $portfolios->id }}"class="form-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="slug" value="{{ $portfolios->slug }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" id="texarea">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="description">{!! $portfolios->description !!}</textarea>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-sm-2 control-label" for="project_url">Project Url</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="project_url" value="{{ $portfolios->project_url }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @if( $portfolios->image )
                                            <img src="{{ $portfolios->image }}" style="max-width: 150px;width: 100%;border-radius: 2%;border: 1px solid #040b14;margin: 12px 10px;">
                                        @endif
