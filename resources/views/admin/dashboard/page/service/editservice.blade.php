                            ...
                            <div class="general-label">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="id" hidden value="{{ $service->id }}"class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    @if( $service->icon )
                                        <img src="{{ $service->icon }}" style="max-width: 20px;width: 100%;border-radius: 2%;border: 1px solid #040b14;margin: 12px 10px;">
                                    @endif
                                </div>
