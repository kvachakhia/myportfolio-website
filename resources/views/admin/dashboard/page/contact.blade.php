                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body form-horizontal" >
                        ...
                        @endif
                            ...
                            <h5 class="header-title pb-5">Contact</h5>       
                                        ...
                                        @foreach ($contacts as $contact)
                                            <tr>
                                                <form action="{{ route('contactcontactKeyDelete',$contact->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <td>{{ $contact->key_name }}</td>
                                                    <td>{{ substr( $contact->value,0,50) }}</td>
                                                    
                                                    <td>
                                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#updatekey{{$contact->id}}">Update</button>
                                            ...
                                            <div class="modal fade" id="updatekey{{$contact->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('contactKeyUpdate',$contact->id) }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 control-label" for="key_name">Key</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="key_name" value="{{ $contact->key_name }}" class="form-control" placeholder="Key">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="value" value="{{ $contact->value }}" class="form-control" placeholder="value">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="id" value="{{ $contact->id }}" hidden class="form-control" placeholder="value">
                                                                </div>
                                                            </div>
